...
%% ANN architecture
NNT_Archi=importdata('aux_data\NNT_Archi.mat');
...
bounding_box=importdata('SL2P_regularizing-master\tools\aux_data\BIO_VAR_bounding_box.mat');
eval(['bounding_box=bounding_box.',upper(database_0.bvar),';']);
...
database_0.all_1=sortrows([database_0.reg_1;database_0.learn;database_0.reg_CL],1);
end
